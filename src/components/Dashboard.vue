...
async function handlePriceSet( proj ) {
  try {
    ...
    if (response.ok) {
      // Simulate new state after pricing is set
      proj.price_status = price_status[2]; // e.g., 'waiting for response'
    } else {
...
<template>
<Header :context="'dashboard'" :admin='isAdmin' />
    ...
    <div class="row align-items-center">
      <div class="col-12">
        ...
        <div class="row">
                ...
                <div 
                  ...
                  <div class="project-info">
                    ...
                    <p class="project-status">
                      Status: 
                      <span 
                        :style="{ color: project.status === 'Simulation Complete' ? themeColorOrange : themeColor }">
                        {{ project.status }}
                      </span>
                    </p>
                  ...
                  <div class="project-actions ">
                    <!-- Download button -->
                    <a :href="`${download_api_endpoint}/${project.id}`" 
          ...
          <!--           <\!-- Confirmation Prompt -\-> -->
          <!--           <div v-if="handle_price_set_confirmation" class="confirmation-overlay"> -->
          <!--             <div class="confirmation-box"> -->

          <!--               <p> -->
          <!--                 Are you sure you want to set the price for -->
          <!--                 making this project? -->
          <!--               </p> -->
          ...
          <!--   </div> -->
          <!-- </div> -->
          <!--           <\!-- Price Display with Status Icon -\-> -->
